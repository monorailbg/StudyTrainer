...
export default function CompanyPage() {
  ...
  if (!company) {
    return (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: 'calc(100vh - 72px)', gap: '12px', color: 'var(--text-2)' }}>
  ...
  return (
    <div style={{ background: 'var(--bg-page)', minHeight: 'calc(100vh - 72px)' }}>
