...
const T = {
  en: {
    ...
    gen_api_key_label: 'Anthropic API Key',
    gen_api_key_placeholder: 'sk-ant-...',
    gen_api_key_save: 'Save',
    gen_api_key_change: 'Change Key',
    gen_api_key_stored: 'API key stored locally',
  ...
  ja: {
    ...
    gen_api_key_label: 'Anthropic APIキー',
    gen_api_key_placeholder: 'sk-ant-...',
    gen_api_key_save: '保存',
    gen_api_key_change: 'キーを変更',
    gen_api_key_stored: 'APIキーをローカルに保存済み',
